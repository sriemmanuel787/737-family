...
var canvasBase = {
	...
	obj.alt_mask = obj.grpAlt.createChild("image").setTranslation(5, 6).set("z-index",10000).set("blend-source","zero").set("blend-destination-rgb","one").set("blend-destination-alpha","one-minus-src-alpha").set("src", "Aircraft/fly/Nasal/Displays/alt_mask.png");
	setup: func() {
