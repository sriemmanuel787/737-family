...
var SYSTEM = {
	autoConfigRunning: props.globals.initNode("/systems/acconfig/autoconfig-running", 1, "BOOL"),
	Error: {
	...
	simInit: func() {
		...
		if (!CONFIG.noUpdateCheck) {
			http.load("https://raw.githubusercontent.com/sriemmanuel787/737-MAX/master/revision.txt").done(func(r) me.newRevision.setValue(r.response));
		}
