...
var Sim = {
	day:         props.globals.getNode("/sim/time/demand-day"),
	monthStr:    props.globals.getNode("/sim/time/demand-month"),
	monthInt:    props.globals.getNode("/sim/time/demand-month-idx"),
	year:        props.globals.getNode("/sim/time/demand-year"),
