...
var autostart = func {
	...
	setprop("controls/fuel/pump-lf", 1);
	setprop("controls/fuel/pump-la", 1);
	setprop("controls/fuel/pump-rf", 1);
	setprop("controls/fuel/pump-ra", 1);
...
var shutdown = func {
	...
	setprop("controls/engines/engine[0]/cutoff", 1);
	setprop("controls/engines/engine[1]/cutoff", 1);
	setprop("controls/fuel/pump-lf", 0);
	setprop("controls/fuel/pump-la", 0);
	setprop("controls/fuel/pump-rf", 0);
	setprop("controls/fuel/pump-ra", 0);
